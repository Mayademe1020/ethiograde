...
class _StudentDetailScreenState extends State<StudentDetailScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: results.isNotEmpty ? () => _exportReportCard(context) : null,
          ),
          IconButton(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (student.studentId.isNotEmpty) _InfoRow(label: 'ID', value: student.studentId),
                if (student.gender.isNotEmpty) _InfoRow(label: 'Gender', value: student.gender == 'M' ? 'Male' : 'Female'),
                if (student.className.isNotEmpty) _InfoRow(label: 'Class', value: student.className),
              ],
            ),
          ),
        ],
        ...
        children: [
          Row(
            children: [
              ...
              Text('Performance', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
              const Spacer(),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(trend.label, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: trend.color)),
                    ],
                  ),
                ),
            ],
          ...
          Row(
            children: [
              _MiniStat(label: 'Exams', value: '${stats.examCount}', color: cs.primary),
              const SizedBox(width: 16),
              _MiniStat(
                label: 'Average',
                value: stats.examCount > 0 ? '${stats.average.toStringAsFixed(0)}%' : '--',
                color: stats.average >= 50 ? AppTheme.primaryGreen : AppTheme.primaryRed,
              ),
              const SizedBox(width: 16),
              _MiniStat(label: 'Best', value: stats.topGrade.isNotEmpty ? stats.topGrade : '--', color: AppTheme.primaryGreen),
              const SizedBox(width: 16),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('100%', style: TextStyle(fontSize: 9, color: AppTheme.lightText)),
                      Text('75%', style: TextStyle(fontSize: 9, color: AppTheme.lightText)),
                      Text('50%', style: TextStyle(fontSize: 9, color: AppTheme.lightText)),
                      Text('25%', style: TextStyle(fontSize: 9, color: AppTheme.lightText)),
                      Text('0%', style: TextStyle(fontSize: 9, color: AppTheme.lightText)),
                    ],
                  ),
                ),
                const SizedBox(width: 8),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text('Topics', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
            ],
          ),
          const SizedBox(height: 4),
          Text('Strengths & areas to review', style: TextStyle(fontSize: 12, color: AppTheme.lightText)),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(topic, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
  ...
  Widget _buildGradeHistory(BuildContext context, List<ScanResult> results) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Recent Results', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
  ...
  _StudentStats _computeStats(List<ScanResult> results) {
    ...
    if (results.isNotEmpty) {
      ...
      if (pct >= 90) rank = 'Top 10%';
      else if (pct >= 75) rank = 'Top 25%';
  ...
  void _editStudent(BuildContext context) async {
    await Navigator.pushNamed(context, AppRoutes.addStudent, arguments: widget.student);
