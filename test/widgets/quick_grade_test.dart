...
void main() {
  ...
  group('QuickGradeScreen — English', () {
    ...
    testWidgets('valid input keeps scan action available', (tester) async {
      await tester.pumpWidget(buildScreen());
      await tester.pumpAndSettle();
    ...
    testWidgets('valid true/false input keeps scan action available', (
      tester,
    ) async {
      await tester.pumpWidget(buildScreen());
      await tester.pumpAndSettle();
      ...
      await tester.enterText(find.byType(TextFormField).last, 'A,T');
  ...
  group('QuickGradeScreen — UI structure', () {
    ...
    testWidgets('lowercase answer input keeps scan action available', (
      tester,
    ) async {
      await tester.pumpWidget(buildScreen());
      await tester.pumpAndSettle();
